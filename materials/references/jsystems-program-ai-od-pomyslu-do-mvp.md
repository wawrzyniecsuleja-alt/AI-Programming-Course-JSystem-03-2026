# JSystems Program Reference — AI dla programistów: od pomysłu do MVP

Source URL:
- https://jsystems.pl/szkolenia-ai;ai_dla_programistow_od_pomyslu_do_mvp.szczegoly
...
Nie jest wymagane wcześniejsze doświadczenie z narzędzia AI – jedyny warunek to otwarty umysł i chęć gruntownej zmiany swojego sposobu pracy. Kurs może zahaczać o obszary spoza Twojej specjalizacji, pokazując, jak AI może Ci tam pomóc – czy to przez generowanie kodu, czy przez przyspieszenie nauki.
...
- Konfiguracja środowiska (Codex CLI, Codex Desktop, WezTerm, Claude Code CLI, IntelliJ Junie/AI Assistant, API keys)
...
- Codex Desktop + Codex CLI jako główne narzędzia; Claude Code CLI i IntelliJ Junie/AI Assistant jako porównanie
- Funkcje: autocomplete, chat, inline edits, integracja z terminalem (WezTerm)
- Dokumentacja, koszty: subskrypcje, API keys, modele lokalne
- **Cel:** Implementacja głównej logiki UI

#### Moduł 3.2: Full-Stack Generation & CLI Power
- Generowanie backendu API
- CLI tools: Codex CLI, Claude Code — analiza codebase z terminala
...
- CodeRabbit, Qodo, Gemini Code Assist
